...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-white/80 backdrop-blur-md border-t border-gray-200 text-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <span className="text-2xl font-bold text-gray-800">BotSeller</span>
            </motion.div>
            ...
            >
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center hover:bg-purple-500 hover:text-white transition-all duration-200"
                >
          ...
          >
            <h3 className="text-lg font-semibold mb-4 text-gray-800">Услуги</h3>
        ...
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-3 gap-6 py-8 border-t border-gray-300 mb-8"
        >
          <div className="flex items-center space-x-3">
            <Mail className="w-5 h-5 text-blue-400" />
            <div>
              <p className="text-sm text-gray-500">Email</p>
              <p className="text-gray-800">info@botseller.ru</p>
            </div>
          </div>
          <div className="flex items-center space-x-3">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-800">Москва, Россия</p>
            </div>
          </div>
        </motion.div>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.9 }}
        className="fixed bottom-8 right-8 w-12 h-12 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center z-50"
      >
